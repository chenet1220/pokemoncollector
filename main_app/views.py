...
def pokemon_index(request):
    ...
    return render(request, 'pokemons/index.html', {'pokemon': random_pokemon})
...
def poke_detail(request, poke_id):
    ...
    if response.status_code == 200:
        ...
        image_url = data['sprites']['other']['official-artwork']['front_default']
        return render(request, 'pokemons/detail.html', {'pokemon': Pokemon(name, poke_id, xp, type, abilities, image_url), 'moves': moves})
    else:
